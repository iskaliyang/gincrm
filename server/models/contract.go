...
type Contract struct {
	...
	Cid                 int64                `gorm:"cid"`
	ContractProductList *ContractProductList `gorm:"column:product_list;type:json"`
...
type ContractCreateParam struct {
	...
	ContractProductList *ContractProductList `json:"product_list"`
...
type ContractInfo struct {
	...
	OverTime            string               `json:"overTime"`
	Remarks             string               `json:"remarks"`
	ContractProductList *ContractProductList `json:"product_list" gorm:"column:product_list;type:json"`
	Status              int                  `json:"status"`
}
...
type ContractProductList []*Products

func (p *ContractProductList) Value() (driver.Value, error) {
	b, err := json.Marshal(p)
	return string(b), err
}

func (p *ContractProductList) Scan(src any) error {
