                        ...
                        <a-row :gutter="50">
                            <a-col :span="12">
                                <a-form-item label="STMP服务器" name="stmp">
                                    <a-input v-model:value="mailConfig.stmp" placeholder="请输入域名">
                                        <template #suffix>
                                            <a-tooltip>
                                                <template #title>如 smtp.qq.com</template>
                                            </a-tooltip>
                                        </template>
                                    </a-input>
                                </a-form-item>
                            ...
                            <a-col :span="12">
                                <a-form-item label="端口号" name="port">
                                    <a-input-number v-model:value="mailConfig.port" placeholder="请输入端口号"
                                        ...
                                        <template #suffix>
                                            <a-tooltip>
                                                <template #title>STMP服务对应的端口号</template>
                                            </a-tooltip>
                                        </template>
                                    </a-input-number>
                                </a-form-item>
                            ...
                            <a-col :span="12">
                                <a-form-item label="授权码" name="authCode">
                                    <a-input v-model:value="mailConfig.authCode" placeholder="请输入授权码">
                                        <template #suffix>
                                            <a-tooltip>
                                                <template #title>从STMP服务器提供商获得的授权码</template>
                                            </a-tooltip>
                                        </template>
                                    </a-input>
                                </a-form-item>
                            ...
                            <a-col :span="12">
                                <a-form-item label="邮箱账号" name="email">
                                    <a-input v-model:value="mailConfig.email" placeholder="请输入邮箱">
                                        <template #suffix>
                                            <a-tooltip>
                                                <template #title>开启STMP服务时所使用的邮箱账号</template>
                                            </a-tooltip>
                                        </template>
                                    </a-input>
                                </a-form-item>
                            ...
                            <a-col :span="12">
                                <a-form-item label="服务有效性检测" name="usability">
                                    <a-select ref="select" v-model:value="usability" @focus="focus" disabled
                                        @change="handleChange" placeholder="自动检测服务有效性">
                            ...
                            <a-col :span="12">
                                <a-form-item><br />
                                    ...
                                    <a-button type="primary" style="margin-left: 20px;" @click="reset"
                                        ghost>重置</a-button>
